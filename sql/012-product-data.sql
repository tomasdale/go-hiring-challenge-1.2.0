...
('PROD001', 10.99, (SELECT id FROM categories WHERE code = 'CAT001')),
('PROD002', 12.49, (SELECT id FROM categories WHERE code = 'CAT002')),
('PROD003', 8.75, (SELECT id FROM categories WHERE code = 'CAT003')),
('PROD004', 15.00, (SELECT id FROM categories WHERE code = 'CAT001')),
('PROD005', 22.99, (SELECT id FROM categories WHERE code = 'CAT003')),
('PROD006', 5.50, (SELECT id FROM categories WHERE code = 'CAT002')),
('PROD007', 18.20, (SELECT id FROM categories WHERE code = 'CAT001')),
('PROD008', 9.99, (SELECT id FROM categories WHERE code = 'CAT003'));
